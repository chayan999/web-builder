        ...
        <div class='container-fluid footer-bg'>
            <div class="card">
                ...
                <div class="card-footer row m-0">
                    ...
                    <div>
                        <p> <small class="follow-text">FOLLOW US ON SOCIAL MEDIA</small> <label class="footer-right"> <i class="fab fa-instagram"></i> <i class="bi bi-facebook"></i> <i class="fa-linkedin"></i> <i class="fab fa-twitter-square"></i> </label> </p>
                    </div>
                </div>
            </div>
        </div>
